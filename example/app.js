...
var _uiLoader = require('../src/ui-loader.jsx');
...
var App = (function (_React$Component) {
  ...
  function App(props) {
    ...
    _this._spinForever = _this._spinForever.bind(_this);
    _this.state = {
      ready: false
    };
    return _this;
...
_reactDom2.default.render(_react2.default.createElement(App, { timeout: 4000 }), document.getElementById('example'));

},{"../src/ui-loader.jsx":160,"react":159,"react-dom":3}],2:[function(require,module,exports){
...
var UILoader = (function (_React$Component) {
  ...
  function UILoader(props) {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(UILoader).call(this, props));
  }
    ...
    value: function render() {
      if (this.props.ready) {
        ...
        return _react2.default.createElement(
          'div',
          { className: 'ui-loader' },
          _react2.default.createElement('div', { className: 'ui-loader-bg' }),
          _react2.default.createElement(
            'div',
